 ...
 * This is the main class of this repository
 * @author evanmcarlson
 *
 */
public class EfficiencyTest {
	 ...
	 * @param arraySize
	 */
	public EfficiencyTest(int arraySize) {
		populationStrategy = "random";
	 ...
	 */
	public EfficiencyTest(int arraySize, String populationStrategy) {
	...
	public static void main(String[] args) {
		...
		EfficiencyTest timing = new EfficiencyTest();
